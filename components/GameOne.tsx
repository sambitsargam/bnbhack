...
import contributionData from "../data/gaming.json";
...
export function GameOnee({
  ...
  const columns = React.useMemo<ColumnDef<Contribution>[]>(
    () => [
      ...
      {
        header: "Gameplay Date",
        accessorKey: "created_at",
      },
      {
        header: "Amount",
        accessorKey: "amount_in_busd",
  ...
  }, [contributionData, risk, score, status, contributionDate]);
