...
import { GameOnee } from "../../components/GameOne";
import { GameTwoo } from "../../components/GameTwo";
import { categories, riskLevel, rounds } from "../../data";
import InGamePurchaseComponent  from "../../components/InGamePurchaseComponent";
  ...
  return (
    <div className="p-4">
      ...
      <main className="mb-40">
        ...
        <ColGrid numColsMd={4} gapX="gap-x-6" gapY="gap-y-6" marginTop="mt-6">
          <Col numColSpanMd={1}>
            <Card hFull>
              ...
              <Text>Total addresses based on Rating score level</Text>
              <BarChart
                data={passportData}
                dataKey="name"
        ...
        <Card marginTop="mt-6">
        <InGamePurchaseComponent address="0x0C41A7Dd013B9062Ef38B48E905a985c262B248b" />
        </Card>
      </main>
    </div>
  );
